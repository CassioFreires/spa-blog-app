...
        
        // CORREÇÃO: A API agora retorna um objeto com 'data' ou 'message'.
        // Se a resposta tiver a propriedade 'data' e for um array, usa-se `response.data`.
        // Caso contrário, se a API retornar uma mensagem, o erro é tratado.
        // A API também retorna um objeto com a chave "data" para as postagens.
